...
pygame.display.set_caption("For Speed")
icono=pygame.image.load("sprites/sangre.png")
...
soundPoints = pygame.mixer.Sound(directory + "\\sounds\\points.mp3")
...
class thing(pygame.sprite.Sprite):
    ...
    def __init__(self, lane):
        ...
        self.image = pygame.image.load(directory + "\\sprites\\diamondo.png").convert_alpha()
        self.rect = self.image.get_rect()
...
def playMusic(music):
    ...
    if music == "main":
        pygame.mixer.music.load(directory + "\\sounds\\music.mp3")
...
def menu():
    ...
    instBtn = button(BLACK, 300, 330, 200, 25, "INSTRUCTIONS")
...
def instructions():
    ...
    label1 = myfont.render("- Gana puntos matando zombies", 1, WHITE, BLUE)
    label2 = myfont.render("- Agotas la energía de tu carro cuando chocas", 1, WHITE, BLUE)
    label3 = myfont.render("- Aumenta la velocidad cada vez que ganas puntos", 1, WHITE, BLUE)
    label4 = myfont.render("- ¡¡Suerte!!", 1, WHITE, BLUE)
...
def enterName():
    ...
    labelEnterName = myfont.render("Enter user name:", 1, WHITE)
